...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", function () {
          ...
          describe("fund", function () {
             ...
             // it("Fails if you don't send 1 ETH", async () => {
            ...
            //  it("Fails if you send less than , 50 * 10**18 ETH", async () => {
             //   const currentValue = await fundMe.fund({ value: sendValue })
              //  const expectedValue = 
                // assert
                // expect
                //assert.equal(fundMe.fund(), expectedValue)
            //    await expect(currentValue).to.below(expectedValue)
           //  })
